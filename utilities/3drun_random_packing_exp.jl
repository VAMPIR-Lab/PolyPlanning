...
exp_file_date = "2024-09-09_1153"
res_file_date = "2024-09-09_1153"
...
if is_loading_res
    our_sols, sep_sols, dcol_sols, kkt_sols = PolyPlanning.load_all(exp_name, exp_file_date, res_file_date; is_loading_our=is_running_ours, is_loading_sep=is_running_sep, is_loading_dcol=is_running_dcol, is_loading_kkt=is_running_kkt, data_dir)
else
    our_sols, sep_sols, dcol_sols, kkt_sols = PolyPlanning.compute_all_3d(ego_poly, x0s, maps, param; is_saving, exp_name, date_now, exp_file_date,is_running_ours, is_running_sep, is_running_dcol, is_running_kkt, data_dir)
end
